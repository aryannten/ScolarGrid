    ...
    <div className="min-h-screen flex bg-light-bg dark:bg-dark-bg">
      ...
      >
        <div className="w-full max-w-md">
          ...
          {/* Google OAuth */}
          <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-xl text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-dark-hover transition-colors">
